...
namespace Material.Blazor
{
    ...
    public partial class MBDrawer : ComponentFoundation
    {
        ...
        {
            isOpen = open;
            InvokeAsync(() => InstantiateMdcComponent());
        }
        ...
        /// <inheritdoc/>
        private protected override async Task InstantiateMdcComponent() => await JsRuntime.InvokeVoidAsync("MaterialBlazor.MBDrawer.toggle", DrawerElem, isOpen);
    }
}
